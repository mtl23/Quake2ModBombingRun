...
void Weapon_Griffball (edict_t *ent);
...
qboolean Pickup_Ammo (edict_t *ent, edict_t *other)
{
	...
	if (!(ent->spawnflags & (DROPPED_ITEM | DROPPED_PLAYER_ITEM)) && (deathmatch->value))
		if(ent->classname!="Griffball")// griffball should not respawn over time
		SetRespawn (ent, 30);
	return true;
}
...
edict_t *Drop_Item (edict_t *ent, gitem_t *item)
{
	...
	VectorScale (forward, 500, dropped->velocity);
	dropped->velocity[2] = 500;
...
void SpawnItem (edict_t *ent, gitem_t *item)
{
	...
	/*if (ent->spawnflags)
	{
		if (strcmp(ent->classname, "key_power_cube") != 0)
		{
			...
			gi.dprintf("%s at %s has invalid spawnflags set %i\n", ent->classname, vtos(ent->s.origin),ent->spawnflags);
			ent->spawnflags = 0;
		}
	}*/
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*QUAKED Pipe (.3 .3 1) (-16 -16 -16) (16 16 16)
*/
  {
         "weapon_pipe", 
         NULL,
         ...
         NULL, 
         0,
		"models/weapons/v_blast/tris.md2",      //Model name trying to change this
         NULL,                                     
         "Lead_Pipe",                              //Display name
         0,
         0,
         NULL,
         IT_WEAPON,
         NULL,
         0,
        /* precache */ "grapple/grhit.wav" 
                                                       
  },
  
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*QUAKED Hammer (.3 .3 1) (-16 -16 -16) (16 16 16)
*/
  {
         "weapon_hammer", 
         NULL,
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*QUAKED Club (.3 .3 1) (-16 -16 -16) (16 16 16)
*/
  {
         "weapon_club", 
         NULL,
  ...
  /*QUAKED Griffball (.3 .3 1) (-16 -16 -16) (16 16 16)
*/
  {
		...
		Use_Weapon,
		Drop_Weapon,
		Weapon_Griffball,//griffball weapon function
		"misc/am_pkup.wav",
		"models/items/ammo/grenades/medium/tris.md2", EF_ROTATE,// grenade model
		"models/weapons/v_handgr/tris.md2", //  holding a grenade model
/* icon */		NULL,
/* pickup */	"Griffball",
/* width */		0,
				0,
